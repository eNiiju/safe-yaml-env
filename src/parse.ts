...
type Data = string | number | boolean | null | undefined | DataArray | DataObject;
interface DataArray extends Array<Data> {}
interface DataObject { [key: string]: Data; }
...
*/
export async function loadYamlAsync(filePath: string, schema: ZodSchema): Promise<unknown> {
